...
public class Week3MenuApp {
	static Scanner s = new Scanner (System.in); // import java.util.Scanner; "Scanner"
	...
	public static void main(String[] args) {
		...
		while(decision != -1)	{
			showMenu();
			decision = s.nextInt();
			//method that handles the difference differintiators
